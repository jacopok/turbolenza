...
Possiamo inoltre assimilare gli effetti della turbolenza ad un incremento della viscosità (non reale, ma efficace). $\nu_T = \nu + \nu'$.

Definiamo la \emph{velocità di frizione} $v_{\ast} $

\begin{equation}
v_{\ast} = \sqrt{\frac{\tau_b}{\rho}}
\end{equation}
...
La luminanza è stata spesso usata da artisti (dall'inizio dell'impressionismo) per trasmettere una sensazione di movimento. 
