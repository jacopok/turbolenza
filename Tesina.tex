...
\begin{figure}[h]
    ...
    \caption{Densità di probabilità della variazione di luminanza per diverse distanze $R_i = 60, 240, 400, 600, 800, 1200$ dal basso in alto.}
    \label{gaussians}
\end{figure}
...
(\delta v_R )^2
\right\rangle\right)^{1/2} = \norm{\delta v}$ è la norma del vettore $\delta v_R$).
...
Entrambi questi risultati sono riferiti al quadro ``Notte Stellata'' (\ref{starrynight}), del 1889
