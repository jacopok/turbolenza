...
L'integrale volumetrico del termine $\mathbf{s}$ comprende tutti gli altri tipi di forze che possono agire sull'infinitesimo di volume, che dividiamo in pressione e forze viscose (ovvero, nello \emph{stress tensor}
...
consideriamo prima le componenti ortogonali e poi gli sforzi di taglio).

\subparagraph{Pressione}

Guardiamo la forza esercitata dalla pressione lungo una sola dimensione, come la $x$:
